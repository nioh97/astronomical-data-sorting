      ...
      <div className="container mx-auto px-4 py-12 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-slate-700 text-sm">SKYSCRIBE Data Fusion</p>
        ...
        <div className="border-t border-slate-200 pt-6">
          <p className="text-xs text-slate-600 text-center">
            SKYSCRIBE Data Fusion Platform - Enabling unified analysis of astronomical datasets from multiple space agencies.
          </p>
          <p className="text-xs text-slate-500 text-center mt-3">
            © {currentYear} SKYSCRIBE Data Fusion Platform. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
